        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className={cn(
                "bg-gray-800 w-full pl-3 text-left font-normal text-lavender-200 border-indigo-700/50 hover:ring-2 hover:ring-cyan-400/50 transition"
              )}
            >
              {date ? format(date, "PPP") : "Pick a date"}
              <CalendarIcon className="bg-black ml-auto h-4 w-4 opacity-50" />
            </Button>
          </PopoverTrigger>
          <PopoverContent className="w-auto p-0 bg-gray-900 text-white rounded-lg shadow-lg">
            <Calendar
