...
// // import EmailTemplate from "@/app/api/inngest/template";
...
Here’s your financial report for ${monthName}:
- Total Income: $${stats.totalIncome}
- Total Expenses: $${stats.totalExpenses}
- Net Income: $${stats.totalIncome - stats.totalExpenses}
...
Your budget for ${defaultAccount.name} has reached ${percentageUsed.toFixed(1)}%.
Spent: $${totalExpenses} / Budget: $${budgetAmount}
